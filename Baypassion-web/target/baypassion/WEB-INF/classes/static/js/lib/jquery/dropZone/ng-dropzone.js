            ...
            return {
                ...
                return {
                    ...
                    link: function (scope, iElem, iAttr) {
                        ...
                        scope.methods.getAcceptedFiles = function () {
                            return dropzone.getAcceptedFiles(); //Return all files
                        };


                        var controlMethods = [
                            'removeFile', 'removeAllFiles', 'processQueue',
                            'getRejectedFiles', 'getQueuedFiles', 'getUploadingFiles',
